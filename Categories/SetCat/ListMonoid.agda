module Categories.SetCat.ListMonoid ℓ (X : Set ℓ) where

open import Data.List using (List; [_]; []; _∷_; _++_; foldl)
open import Data.Product using (Σ-syntax; _,_)

open import Axioms hiding ([_])

open import Categories.SetCat ℓ
open import Categories.SetCat.ListEndofunctor ℓ

open import Structures.Category
open import Structures.Functor
open import Structures.Monoid ℓ
...
crushMapHomomorphism : ∀ n → (X ⇒ Carrier {{n}}) → (ListMonoid ⇒ᴹ n)
